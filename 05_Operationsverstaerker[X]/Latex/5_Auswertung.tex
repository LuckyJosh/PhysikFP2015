...
\input{../Tabellen/Gegengekoppelter_Verstaerker_Widerstaende}
...
\input{../Tabellen/Gegengekoppelter_Verstaerker_1.tex}
\input{../Grafiken/fig_Gegengekoppelter_Verstaerker_1}

\input{../Tabellen/Gegengekoppelter_Verstaerker_2.tex}
\input{../Grafiken/fig_Gegengekoppelter_Verstaerker_2}

\input{../Tabellen/Gegengekoppelter_Verstaerker_3.tex}
\input{../Grafiken/fig_Gegengekoppelter_Verstaerker_3}

\input{../Tabellen/Gegengekoppelter_Verstaerker_4.tex}
\input{../Grafiken/fig_Gegengekoppelter_Verstaerker_4}

\input{../Tabellen/Gegengekoppelter_Verstaerker_Verstaerkung.tex}
\input{../Tabellen/Gegengekoppelter_Verstaerker_Parameter.tex}
\FloatBarrier
...
\input{../Grafiken/fig_Ersatzschaltbild}
...
\input{../Tabellen/Gegengekoppelter_Verstaerker_Phase.tex}
\input{../Grafiken/fig_Gegengekoppelter_Verstaerker_Phase}
...
\begin{empheq}{equation}
	U_\text{A,theo}= \frac{U_{\mathrm{g}}}{R_{\mathrm{V}}} R_\text{N}
\end{empheq}
...
\begin{empheq}{equation}
	V_{\mathrm{theo}} = \frac{R_{\mathrm{N}}}{r_{\mathrm{e}}}=\frac{R_{\mathrm{N}}}{R_{\mathrm{V}}} 
...
\begin{empheq}{align*}
	R_{\mathrm{V}} &= \SI{100(1)}{\ohm}\,\, \text{und}\\
	R_{\mathrm{N}} &= \SI{10.0(1)}{\kilo\ohm}
\end{empheq}
verwendet.
...
\input{../Tabellen/Amperemeter_1.tex}

\input{../Tabellen/Amperemeter_2.tex}

%\input{../Grafiken/fig_Amperemeter_Eingangswiderstand}
%\input{../Grafiken/fig_Amperemeter_Leerlaufverstaerkung}
\input{../Grafiken/fig_Amperemeter_Leerlaufverstaerkung_Eingangswiderstand}
...
\input{../Tabellen/Integrator_Differntiator.tex}

\input{../Grafiken/fig_Integrator_Frequenz}
\input{../Grafiken/fig_Integrator_Oszilloskop_Sinus}
\input{../Grafiken/fig_Integrator_Oszilloskop_Dreieck}
\input{../Grafiken/fig_Integrator_Oszilloskop_Rechteck}
\input{../Grafiken/fig_Differentiator_Frequenz}
\input{../Grafiken/fig_Differentiator_Oszilloskop_Sinus}
\input{../Grafiken/fig_Differentiator_Oszilloskop_Dreieck}
\input{../Grafiken/fig_Differentiator_Oszilloskop_Rechteck}
...
\input{../Grafiken/fig_Funktionsgenerator_real}
...
\input{../Grafiken/fig_Funktionsgenerator}
