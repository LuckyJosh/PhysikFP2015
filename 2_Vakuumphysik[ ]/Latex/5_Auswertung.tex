...
\input{../Tabellen/Bauteil_Abmessungen}


\input{../Grafiken/Bauteile}
...
\input{../Tabellen/Evakuierungskurve_Drehschieber}
...
\input{../Grafiken/fig_Evakuierungskurve_Drehschieber_exp}
\FloatBarrier}

{%Logarithmische-Darstellung der Messdaten mit Fits
\input{../Grafiken/fig_Evakuierungskurve_Drehschieber_log_0}
\FloatBarrier
\input{../Grafiken/fig_Evakuierungskurve_Drehschieber_log_1}
\FloatBarrier
\input{../Grafiken/fig_Evakuierungskurve_Drehschieber_log_2}
\FloatBarrier
\input{../Grafiken/fig_Evakuierungskurve_Drehschieber_log_3}
\FloatBarrier}
...
\input{../Tabellen/Leckrate_Drehschieber}
\FloatBarrier
Die grafische Darstellung der jeweiligen Messreihe befindet sich in den Abbildungen \ref{fig:leckrate_drehschieber_0} 
bis \ref{fig:leckrate_drehschieber_3} jeweils zusammen mit einer durch lineare Ausgleichsrechnung bestimmten Geraden. Für die Berechnung dieser Geraden, wurden die grau dargestellten Gleichgewichtsdrücke $P_g$ für $t=0$ nicht verwendet, da beim schließen des Ventils 
...
\FloatBarrier
\input{../Grafiken/fig_Leckrate_Drehschieber_1}
\FloatBarrier
\input{../Grafiken/fig_Leckrate_Drehschieber_2}
\FloatBarrier
\input{../Grafiken/fig_Leckrate_Drehschieber_3}
\FloatBarrier}
...
\input{../Tabellen/Saugvermoegen_Drehschieber}


%Grafik des Saugvermögens
\input{../Grafiken/fig_Saugvermoegen_Drehschieber}
\FloatBarrier
...
%Tabelle der Messwerte
\input{../Tabellen/Evakuierungskurve_Turbo}
...
{%Exponential-Darstellung der Messdaten
\input{../Grafiken/fig_Evakuierungskurve_Turbo_exp}
\FloatBarrier}

{%Logarithmische-Darstellung der Messdaten mit Fits
\input{../Grafiken/fig_Evakuierungskurve_Turbo_log_0}
\FloatBarrier
\input{../Grafiken/fig_Evakuierungskurve_Turbo_log_1}
\FloatBarrier
\input{../Grafiken/fig_Evakuierungskurve_Turbo_log_2}
\FloatBarrier
\input{../Grafiken/fig_Evakuierungskurve_Turbo_log_3}
\FloatBarrier}
...
\input{../Tabellen/Leckrate_Turbo}
Die grafische Darstellung der jeweiligen Messreihe befindet sich in den Abbildungen \ref{fig:leckrate_turbo_0} 
bis \ref{fig:leckrate_turbo_3} jeweils zusammen mit einer durch lineare Ausgleichsrechnung bestimmten Geraden. Für die Berechnung dieser Geraden, wurden die grau dargestellten Gleichgewichtsdrücke $P_g$ für $t=0$ nicht verwendet, da beim schließen des Ventils ein plötzlicher
 Anstieg des Druckes zu bemerken war. 
{%Grafiken der Leckratenmessung
\input{../Grafiken/fig_Leckrate_Turbo_0}
\FloatBarrier
...
%Tabelle zum Saugvermögen
\input{../Tabellen/Saugvermoegen_Turbo}

%Grafik des Saugvermögens
\input{../Grafiken/fig_Saugvermoegen_Turbo}
\FloatBarrier
