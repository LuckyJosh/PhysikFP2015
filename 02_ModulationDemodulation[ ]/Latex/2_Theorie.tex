...
\begin{align}
	U(t)=\hat U \sin\left(\omega_\text{T}t+m\frac{\omega_\text{T}}{\omega_\text{M}}\cos\omega_\text{M}t\right)\label{eq:Frequenzmoduliert}
\end{align}
...
\end{align}
Mithilfe von trigonometrischen Eigenschaften und der Reihenentwicklung für den Sinus lässt sich Gleichung \eqref{eq:Frequenzmoduliert} schreiben als
\begin{align}
 U(t)=\hat U\left[\sin \omega_\text{T}t + \frac{1}{2}m\frac{\omega_\text{T}}{\omega_\text{M}}\cos\left(\omega_\text{T}+\omega_\text{M}\right)t+\frac{1}{2}m\frac{\omega_\text{T}}{\omega_\text{M}}\cos\left(\omega_\text{T}-\omega_\text{M}\right)t\right].
\end{align}
\begin{figure}
	\centering
		\begin{tikzpicture}
