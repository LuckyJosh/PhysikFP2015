...
\end{align}
beschrieben. %Dabei erhält man den Polarisationswinkel des Laserlichts zu 
%\begin{align}
%\phi_{\mathrm{p}} = \phi_0  - \sfrac{\pi}{2}. 
%\label{eq:polarisation_laser}
%\end{align}
