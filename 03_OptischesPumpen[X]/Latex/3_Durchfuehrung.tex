...
\begin{figure}[h!]
	\centering
			...
			\end{tikzpicture}
			\begin{tikzpicture}
				\node [draw=white, anchor=south west] (label) at (0,0) {\includegraphics[trim = 0mm 200mm 50mm 100mm , clip ,width = \textwidth]{../Grafiken/Aufbau_Controlltafel.jpg}};
...
\begin{figure}[h!]
	...
	%\includegraphics[angle = 90]{../Grafiken/Resonanz_1_Exp_Anstieg_05V.jpg}
	%, trim = 50mm 50mm 30mm 70mm, clip, width =  0.49\textwidth , height = 0.3\textwidth
	\includegraphics[angle = 90, trim = 0.5cm 1.65cm 0.3cm 0cm, clip]{../Grafiken/Resonanz_1_Relaxation_4V.jpg}
	%, clip , trim = 45mm 40mm 30mm 30mm, width = 0.49\textwidth , height = 0.3\textwidth
