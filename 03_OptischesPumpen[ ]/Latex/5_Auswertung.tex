...
\input{../Grafiken/fig_Signalbild_RF100kHz.tex}
...
\begin{subequations}
	\begin{empheq}{alignat=4}
		a_{1} &=& \input{../Ergebnisse/Fitparameter_a_Rubidium_87.tex}\qquad
		a_{2} &=& \input{../Ergebnisse/Fitparameter_a_Rubidium_85.tex} \\
		b_{1} &=& \input{../Ergebnisse/Fitparameter_b_Rubidium_87.tex}\qquad
		b_{2} &=& \input{../Ergebnisse/Fitparameter_b_Rubidium_85.tex}
	\end{empheq}
\end{subequations}
...
\begin{empheq}{equation}
	\input{../Ergebnisse/Erdmagnetfeld_Horizontal.tex}.
\end{empheq}
...
\begin{empheq}{align}
	g_{F,1} &= \input{../Ergebnisse/Lande_Faktor_Rubidium_87.tex}\\
	g_{F,2} &= \input{../Ergebnisse/Lande_Faktor_Rubidium_85.tex}
\end{empheq}  
...
\begin{empheq}{align}
	I_{1} &= \input{../Ergebnisse/Kernspin_Rubidium_87.tex}\\
	I_{2} &= \input{../Ergebnisse/Kernspin_Rubidium_85.tex}
\end{empheq}
...
\begin{empheq}{equation}
	R = \input{../Ergebnisse/Anteil_Rubidium_Ratio.tex}.
\end{empheq}
Dieses Verhältnis $R$ entspricht dem Verhältnis $\tfrac{P_{\mathrm{Rb87}}}{P_{\mathrm{Rb85}}}$ woraus,
\begin{empheq}{align}
P_{\mathrm{Rb87}} &= \frac{R}{1+R} = \input{../Ergebnisse/Anteil_Rubidium_87.tex}\\
P_{\mathrm{Rb85}} &= 1-P_{\mathrm{Rb87}} = \input{../Ergebnisse/Anteil_Rubidium_85.tex}
\end{empheq}
folgt.\\
...
\input{../Grafiken/fig_Exponentieller_Anstieg_5V_Rubidium_87.tex} 
\input{../Grafiken/fig_Exponentieller_Anstieg_V6_Rubidium_85.tex}
...
\begin{subequations}
	\begin{empheq}{alignat=4}
	a_{\mathrm{Rb87}} &=& \input{../Ergebnisse/Rubidium_87_Fit_3_a.tex}\qquad
	a_{\mathrm{Rb85}} &=& \input{../Ergebnisse/Rubidium_85_Fit_3_a.tex} \\
	b_{\mathrm{Rb87}} &=& \input{../Ergebnisse/Rubidium_87_Fit_3_b.tex}\qquad 
	b_{\mathrm{Rb85}} &=& \input{../Ergebnisse/Rubidium_85_Fit_3_b.tex}\\
	c_{\mathrm{Rb87}} &=& \input{../Ergebnisse/Rubidium_87_Fit_3_c.tex}\qquad
	c_{\mathrm{Rb85}} &=& \input{../Ergebnisse/Rubidium_85_Fit_3_c.tex}
	\end{empheq}
\end{subequations}
...
\input{../Tabellen/Periodendauern.tex}
...
\input{../Grafiken/fig_Transienteneffekt_Rubidium_87.tex} 

\input{../Grafiken/fig_Transienteneffekt_Rubidium_85.tex}
...
\begin{subequations}
	\begin{empheq}{alignat=4}
	a_{\mathrm{Rb87}} &=& \input{../Ergebnisse/Rubidium_87_Fit_2_a.tex}\qquad
	a_{\mathrm{Rb85}} &=& \input{../Ergebnisse/Rubidium_85_Fit_2_a.tex} \\
	b_{\mathrm{Rb87}} &=& \input{../Ergebnisse/Rubidium_87_Fit_2_b.tex}\qquad 
	b_{\mathrm{Rb85}} &=& \input{../Ergebnisse/Rubidium_85_Fit_2_b.tex}\\
	c_{\mathrm{Rb87}} &=& \input{../Ergebnisse/Rubidium_87_Fit_2_c.tex}\qquad
	c_{\mathrm{Rb85}} &=& \input{../Ergebnisse/Rubidium_85_Fit_2_c.tex}
	\end{empheq}
\end{subequations}
...
\input{../Grafiken/fig_Transienteneffekt_ausgelassen_Rubidium_85.tex}

Die Parameter der dritten Ausgleichskurve ergeben sich zu:
\addtocounter{equation}{-1}
\begin{subequations}
	\begin{empheq}{align}
	a^{\prime}_{\mathrm{Rb85}} &= \input{../Ergebnisse/Rubidium_85_Fit_2_Ausgelassen_a.tex} \\
	b^{\prime}_{\mathrm{Rb85}} &= \input{../Ergebnisse/Rubidium_85_Fit_2_Ausgelassen_b.tex}\\
	c^{\prime}_{\mathrm{Rb85}} &= \input{../Ergebnisse/Rubidium_85_Fit_2_Ausgelassen_c.tex}
	\end{empheq}
\end{subequations}
...
\begin{empheq}{align}
	r &= \frac{b_{\mathrm{Rb85}}}{	b_{\mathrm{Rb87}}} = \input{../Ergebnisse/Verhaelnis_Fit_2_b.tex}\\
